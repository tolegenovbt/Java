...
public class Driver {
    ...
    public static void main(String[] args) throws CloneNotSupportedException, ClassNotFoundException {
        ...
        try {
			...
			Manager m = new Manager("Manager", "Managerov", "16MD00001", "111", ManagerType.OR_MANAGER);
                        ...
                        if(passwordCheck) {
                            ...
                            if(user instanceof Admin) {
                                ...
                                while(true) {
                                    ...
                                    System.out.println("4) to view courses marks");
                                ...
                                while(true) {
                                    System.out.println("1) to create courses");
                                    System.out.println("2) to add courses to techer");
                                    System.out.println("3) to add student to specified courses");
                                    System.out.println("4) quit");

                                    choice = in.readLine();
                                    if(choice.equals("1")){
                                        System.out.println("Enter courses title");
                                        ...
                                        System.out.println("Enter courses number");
                                        choice = in.readLine();
                                ...
                                while(true) {
                                    ...
                                    System.out.println("3) to view students of specified courses");
