...
public class Teacher extends Employee {
    ...
    public Teacher(String name, String surname,int age, String id, String password,Degree degree, Position position) {
    ...
    public void setStudentToCourse(Course course, Student student) {
        ...
        int j = student.courses.size();
        student.courses.put(j, course);
    }
