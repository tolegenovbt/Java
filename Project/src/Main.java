		        	...
		        	if(idCheck && passwordCheck)
		        	{
		        			...
		        			adminsPage : while(true)
		        			{
		        				...
		        				if(choice.equals("1"))
		        				{
		        					...
		        					if(choice.equals("1"))
		        					{
                                        ...
                                        Database.students.add(new Student(inputName,inputSurname, inputAge,inputID,inputPassword, degree, inputYearOfStudy, speciality));
		        					...
		        					else if(choice.equals("2"))
		        					{
                                        ...
                                        Database.teachers.add(new Teacher(inputName,inputSurname,inputAge,inputID,inputPassword,degree,position));
		        					}
		        		...
		        		else if(user instanceof Manager)
		        		{
		        			managersPage: while(true) {
                                ...
                                System.out.println("2) Add courses to techer");
